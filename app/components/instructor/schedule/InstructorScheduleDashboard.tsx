        ...
        <main className="mt-10 space-y-8">
          <section className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-[#071f41] shadow-[0_14px_30px_-20px_rgba(7,31,65,0.35)] transition hover:border-slate-300 hover:bg-slate-50">
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_360px]">
            ...
            <div className="space-y-6">
              <EditSessionPanel selectedSession={selectedSession} />
