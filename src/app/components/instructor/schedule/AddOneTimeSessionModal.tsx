      ...
      >
        <div className="flex items-start justify-between gap-6 border-b border-slate-200 px-6 py-5 sm:px-8">
          <div className="space-y-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Create a single office hour session without changing the
                recurring schedule.
              </p>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={onClose}
            aria-label="Close one-time session modal"
        ...
        <div className="space-y-8 px-6 py-6 sm:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Configure the single-day session details and time window.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-[26px] border border-[#d7e7ff] bg-[#eef5ff] px-5 py-4">
            <p className="text-sm leading-6 text-slate-600">
              One-time sessions only affect the selected date and will not
              change the recurring schedule rules.
            </p>
          </section>
        </div>
